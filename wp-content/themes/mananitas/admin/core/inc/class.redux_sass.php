<?php
    ...
    if ( ! class_exists( 'reduxSassCompiler' ) ) {
        class reduxSassCompiler {
            ...
            public static function compile_single_field( $parent, $sPINAR_CSS_PATH, $filename ) {
                echo 'single field compile: ' . $sPINAR_CSS_PATH . ' ' . $filename;
                ...
                $scss->setImportPaths( $sPINAR_CSS_PATH );
                ...
                $ret = @file_put_contents( $sPINAR_CSS_PATH . '/' . $filename . '.css', $new_css );
            }
        }
    }
